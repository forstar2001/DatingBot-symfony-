...
use App\Services\ConditionAlltimeService;
...
class ConditionAlltimeController extends Controller
{
    private $category = 'All Time Conditions';
    ...
    public function create(Request $request) {
        ...
        try {
            ConditionAlltimeService::create($item);
    ...
    public function update(Request $request) {
        ...
        $item = ConditionAlltime::find($request->id);
        if (empty($item)) {
            $result['success'] = false;
        ...
        try {
            ConditionAlltimeService::update($item);
            return json_encode($result);
        }
        catch (ValidationException $validationException) {
            $result['success'] = false;
    ...
    public function getById(Request $request, $id) {
        ...
        if ($result['success']) {
            try {
                $item = ConditionAlltime::where('id', $id);
